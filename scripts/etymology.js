...
Language.ProtoHellenic = "Proto-Hellenic";
Language.ProtoIndoEuropean = "Proto-Indo-European";
class Word {
    constructor(name, language, origin = null) {
        this.name = name;
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(() => {
    let words = jquery__WEBPACK_IMPORTED_MODULE_0__("#taWords").val();
    for (let word of words.split(" ")) {
        jquery__WEBPACK_IMPORTED_MODULE_0__.getJSON(baseURL, {
            "format": "json",
            "action": "query",
            "titles": word,
            "origin": "*",
            ...
            let page = data.page.revision.text;
        });
    }
});
